...
docker run --rm -it -v "$(pwd):/app" -w /app -p 8080:8080 maven:3.9-amazoncorretto-21 mvn spring-boot:run
...
* The original package name 'com.app.task-manager-app' is invalid and this project uses 'com.app.task_manager_app' instead.
